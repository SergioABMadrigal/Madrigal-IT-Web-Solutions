  ...
  return (
    <div className={`flex flex-col items-center justify-center gap-4 w-full ${window.innerWidth < 800 ? 'px-2 py-4' : 'px-5 py-20'}`}>
      <div className={`${window.innerWidth < 800 ? 'w-full' : 'w-1/2'} max-w-5xl`}>
        ...
        <p ref={ref0} className={`text-lg text-left mt-6 transition-all duration-1050 ease-in-out ${isVisible0 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: delays[0] }}>
        ...
        <p ref={ref1} className={`text-lg text-left mt-6 transition-all duration-1050 ease-in-out ${isVisible1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: delays[1] }}>
        ...
        <p ref={ref2} className={`text-lg text-left mt-6 transition-all duration-1050 ease-in-out ${isVisible2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: delays[2] }}>
        ...
        <p ref={ref3} className={`text-lg text-left mt-6 transition-all duration-1050 ease-in-out ${isVisible3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: delays[3] }}>
        ...
        <p ref={ref4} className={`text-lg text-left mt-6 transition-all duration-1050 ease-in-out ${isVisible4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: delays[4] }}>
          I hold a business license because I take this work seriously. My reputation, reliability, and results are everything to me.
        </p>
        <p ref={ref5} className={`text-lg text-left mt-6 transition-all duration-1050 ease-in-out ${isVisible5 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: delays[5] }}>
        ...
        <div ref={ref6} className={`flex justify-center mt-6 transition-all duration-1050 ease-in-out ${isVisible6 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: delays[6] }}>
